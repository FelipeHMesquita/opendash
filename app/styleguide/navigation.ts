...
export const navigation: NavSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Radar Chart",  href: "/styleguide/components/radar-chart"  },
            { name: "Radial Chart", href: "/styleguide/components/radial-chart" },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Dialogs & Sheets",href: "/styleguide/components/dialogs" },
            { name: "Form Controls",   href: "/styleguide/components/form-controls" },
            { name: "Menus",           href: "/styleguide/components/menus" },
            { name: "Navigation",      href: "/styleguide/components/navigation-elements" },
            { name: "Feedback",        href: "/styleguide/components/feedback" },
